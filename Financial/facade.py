...
if __name__ == "__main__":
    ...
    known_job_id = "fc-01KFPX19EGSEEDPXAESKGQNQTY"
    ...
    payload["series"][0]["fcds"] = generate_daily_fcds(prepared_data_dict['index'], start_idx=252*8)
    print(payload["series"][0]["fcds"])
